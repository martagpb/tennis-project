...
ALTER TABLE TERRAIN ADD (
     CONSTRAINT FK_TERRAIN_CODIFICATION
          FOREIGN KEY (CODE_SURFACE, NATURE)
               REFERENCES CODIFICATION (CODE, NATURE))   ;

ALTER TABLE ENTRAINEMENT ADD (
     CONSTRAINT FK_ENTRAINEMENT_CODIFICATION
          FOREIGN KEY (CODE_NIVEAU, NATURE)
               REFERENCES CODIFICATION (CODE, NATURE))   ;

ALTER TABLE ENTRAINEMENT ADD (
     CONSTRAINT FK_ENTRAINEMENT_PERSONNE
          FOREIGN KEY (NUM_EMPLOYE)
...
ALTER TABLE OCCUPATION ADD (
     CONSTRAINT FK_OCCUPATION_FACTURE
...
ALTER TABLE OCCUPATION ADD (
     CONSTRAINT FK_OCCUPATION_PERSONNE
          FOREIGN KEY (NUM_PERSONNE)
               REFERENCES PERSONNE (NUM_PERSONNE))   ;

ALTER TABLE OCCUPATION ADD (
     CONSTRAINT FK_OCCUPATION_ENTRAINEMENT
...
ALTER TABLE ETRE_AFFECTE ADD (
     CONSTRAINT FK_ETRE_AFFECTE_ENTRAINEMENT
          FOREIGN KEY (NUM_ENTRAINEMENT)
               REFERENCES ENTRAINEMENT (NUM_ENTRAINEMENT))   ;

ALTER TABLE ETRE_AFFECTE ADD (
     CONSTRAINT FK_ETRE_AFFECTE_TERRAIN
          FOREIGN KEY (NUM_TERRAIN)
               REFERENCES TERRAIN (NUM_TERRAIN))   ;

ALTER TABLE ETRE_ASSOCIE ADD (
     CONSTRAINT FK_ETRE_ASSOCIE_OCCUPATION
          FOREIGN KEY (NUM_OCCUPATION)
               REFERENCES OCCUPATION (NUM_OCCUPATION))   ;
...
ALTER TABLE OCCUPER ADD (
     CONSTRAINT FK_OCCUPER_OCCUPATION
          FOREIGN KEY (NUM_OCCUPATION)
               REFERENCES OCCUPATION (NUM_OCCUPATION))   ;

ALTER TABLE PERSONNE ADD (
     CONSTRAINT FK_PERSONNE_CODIFICATION
          FOREIGN KEY (CODE_STATUT_EMPLOYE, NATURE_STATUT_EMPLOYE)
               REFERENCES CODIFICATION (CODE, NATURE))   ;

ALTER TABLE PERSONNE ADD (
     CONSTRAINT FK_PERSONNE_CODIFICATION1
          FOREIGN KEY (CODE_NIVEAU, NATURE_NIVEAU)
               REFERENCES CODIFICATION (CODE, NATURE))   ;