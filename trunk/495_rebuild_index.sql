...
ALTER INDEX I_FK_OCCUPER_CRENEAU;

ALTER INDEX I_FK_OCCUPER_TERRAIN;

ALTER INDEX I_FK_OCCUPER_FACTURE;

ALTER INDEX I_FK_OCCUPER_PERSONNE;

ALTER INDEX I_FK_OCCUPER_ENTRAINEMENT;
