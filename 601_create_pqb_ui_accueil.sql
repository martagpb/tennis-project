...
IS
	...
	BEGIN
		...
		htp.br;
		htp.br;
		htp.Print('BIENVENUE SUR LE SITE DU CENTRE DE TENNIS DE SAINT GILLES CROIX DE VIE LES SAPINS');
		htp.br;
		htp.br;
		htp.print('<img title="Accueil" alt="image" class="accueil" src="' || rep_img || 'accueil.jpg">');	
		htp.br;
		htp.br;
		htp.br;
